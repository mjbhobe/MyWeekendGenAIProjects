...
<<<<<<< HEAD:FinancialAnalystAgentic/src/FinancialAnalystAgentic/financial_analysis_streamlit.py
            analysis = generate_financial_analysis(stock_symbol, financial_analysis_agent)
            
=======
            analysis = generate_financial_analysis(stock_symbol, fa_agent)

>>>>>>> a2a5a7134cc5766c7b833b0549db1ab03442517a:FinancialAnalystAgentic/src/FinancialAnalystAgentic/app2.py
